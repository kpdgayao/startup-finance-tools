...
- There is no flat day rate. The rate is set by how much NEW GROUND the subject covers: \u20b115,000 a day for settled ground (bookkeeping, accounting, cash flow, pricing, valuation), rising to \u20b124,000 a day for a subject needing fresh research — AI applied to accounting, a standard that has just changed, an unfamiliar domain. Two tiers sit between them. Everything else in the quote is a multiplier on that rate or a pass-through cost.
