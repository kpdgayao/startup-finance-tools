...
- A facilitated day in the room is often only half the engagement. Interviews and document review beforehand, and the written plan afterwards, are billed as their own lines at 70% of the day rate — desk work, not room work. These are the parts most often absorbed for free, which is exactly why they are itemised. If the organiser asked for no written output, say plainly that groups who intend to write it up themselves usually do not, and the session stops mattering a month later.
- There is no flat day rate. It is set by TWO things together: how much new ground the subject covers, and which sector the organiser is in. The subject ladder runs \u20b115,000 a day for settled ground (bookkeeping, accounting, cash flow, pricing, valuation) to \u20b124,000 for a subject needing fresh research, AT PUBLIC-SECTOR RATES; a private school pays about 1.6 times that, a cooperative 2, an association 2.5, and a company 3.2. Facilitation is scaled by its OWN, lower sector multipliers — a corporate planning day is \u20b170,000 at the middle rung, not three times the public rate — because the corporate training budget the teaching ladder tracks is not the same market as facilitation. Read the actual day rate off the quote you are given rather than quoting these figures, because the quote already resolved both. Everything else is a multiplier on that rate or a pass-through cost.
