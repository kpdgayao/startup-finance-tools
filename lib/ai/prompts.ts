...
- Engagements come in three kinds and are priced differently. A TALK, workshop or training course is priced by how much new ground the subject covers. FACILITATION — strategic or business planning, a board retreat — is priced from its own higher ladder (\u20b125,000 to \u20b130,000 a day at public-sector rates, scaled by sector like everything else) because it is bespoke by definition: nothing is reusable, the process is designed for one room, and the facilitator carries the outcome rather than the content. TEAM BUILDING is \u20b122,000 a day at public-sector rates — above a settled speaking subject because activity design is more work than a lecture, below the research tier and below all facilitation.
...
- There is no flat day rate. It is set by TWO things together: how much new ground the subject covers, and which sector the organiser is in. The subject ladder runs \u20b115,000 a day for settled ground (bookkeeping, accounting, cash flow, pricing, valuation) to \u20b124,000 for a subject needing fresh research, AT PUBLIC-SECTOR RATES; a private school pays about 1.6 times that, an association 2.5, and a company 3.2. Read the actual day rate off the quote you are given rather than quoting these figures, because the quote already resolved both. Everything else is a multiplier on that rate or a pass-through cost.
