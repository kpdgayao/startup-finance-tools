...
- Engagements come in three kinds and are priced differently. A TALK, workshop or training course is priced by how much new ground the subject covers. FACILITATION — strategic or business planning, a board retreat — is priced from its own higher ladder (\u20b125,000 to \u20b130,000 a day) because it is bespoke by definition: nothing is reusable, the process is designed for one room, and the facilitator carries the outcome rather than the content. TEAM BUILDING sits between them.
